 ...
 */
const StyleguideFieldUsageDate = (props: any) => {
  return (
    <StyleguideSpecimen {...props} e2eId="styleguide-fieldusage-date">
      <ul>
        ...
        <li>
          ...
          */}
          <DateField field={props.fields.date} render={(date: any) => date.toUTCString()} />
        </li>
        <li>
          Localized Date string (local timezone):&nbsp;
          <DateField field={props.fields.date} render={(date: any) => date.toLocaleDateString()} />
        </li>
        <li>
          ...
          {/*
      // @ts-ignore */}
          <DateField field={props.fields.dateTime} render={(date: any) => <em>{date.toLocaleString()}</em>}
          />
        </li>
      </ul>
    </StyleguideSpecimen>
