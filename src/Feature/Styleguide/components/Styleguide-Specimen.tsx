 ...
 */
const StyleguideSpecimen = ({ fields: { heading, description }, children, rendering, e2eId }: any) => (
  <div className="pt-3" id={`i${rendering.uid.replace(/[{}]/g, '')}`} data-e2e-id={e2eId}>
    ...
    <p>
      <small>
        Implementation: <code>/src/components/{rendering.componentName}/index.ts</code>
        <br />
        Definition:{' '}
