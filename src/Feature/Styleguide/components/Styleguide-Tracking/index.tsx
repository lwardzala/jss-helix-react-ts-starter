...
import { dataFetcher } from 'Foundation/Context/services/dataFetcher';
 ...
 */
class StyleguideTracking extends React.Component<any, any> {
  private event: React.RefObject<any>;
  private goal: React.RefObject<any>;
  private outcomeName: React.RefObject<any>;
  private outcomeValue: React.RefObject<any>;
  private campaign: React.RefObject<any>;
  private pageId: React.RefObject<any>;
  private pageUrl: React.RefObject<any>;
